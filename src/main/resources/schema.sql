...
(
    ...
    CONSTRAINT film_id_film_genres_fk FOREIGN KEY (film_id) REFERENCES films (film_id),
    CONSTRAINT genre_id_film_genres_fk FOREIGN KEY (genre_id) REFERENCES genres (genre_id)
);
